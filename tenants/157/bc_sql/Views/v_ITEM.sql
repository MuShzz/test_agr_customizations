...
CREATE VIEW [bc_sql_cus].[v_ITEM] AS
	...
	SELECT DISTINCT
		...
		CAST(CASE WHEN i.[Blocked] = 1 THEN 1
				  ...
				  WHEN i.[Vendor No_] = '5000' AND ix.[Vendor Stock$63a5512e-ef5c-4cc4-ac67-fc1739ce27d8] = '' THEN 1
				  WHEN i.[Vendor No_] = '5000' AND ix.[ICE LAG Order Status Code$63a5512e-ef5c-4cc4-ac67-fc1739ce27d8] <> 1 THEN 1
