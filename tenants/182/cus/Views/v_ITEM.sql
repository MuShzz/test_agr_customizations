...
(
    SELECT
        ...
        si.Weight,
        si.CategoryId,
		CAST(si.DimHeight AS DECIMAL(18,4)) AS Height,
		CAST(si.DimWidth AS DECIMAL(18,4)) AS Width,
		CAST(si.DimDepth AS DECIMAL(18,4)) AS Depth,
...
SELECT
    ...
    CAST(ar.PurchasePrice AS DECIMAL(18,4))              AS [PURCHASE_PRICE],
    CAST(1 AS DECIMAL(18,4))                          AS [ORDER_MULTIPLE],
    CAST(NULL AS DECIMAL(18,4))                       AS [QTY_PALLET],
    CAST((ar.Height * ar.Width * ar.Depth) AS DECIMAL(18,6)) AS [VOLUME],
...
LEFT JOIN cus.StockItem_ExtendedProperties sie ON sie.fkStockItemId = ar.pkStockItemID AND sie.ProperyName = 'landed_cost'
WHERE ar.rn = 1 AND pc.CategoryName = 'Import' 
