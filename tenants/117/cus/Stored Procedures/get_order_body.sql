	...
	BEGIN
		...
		(
			SELECT 
				...
				itemNo AS PartNum,
				CAST(quantity/2 AS DECIMAL(18,4)) AS CalcOurQTY,
				CAST(quantity/2 AS DECIMAL(18,4)) AS CalcVendQTY
				...
				SELECT DISTINCT
					...
					PODetails = (
						SELECT 
							...
							PORels = (
								SELECT 
									CAST(CalcOurQTY AS DECIMAL(18,4)) AS BaseQty,
									CAST(CalcOurQTY AS DECIMAL(18,4)) AS XRelQty,
									CAST(CalcOurQTY AS DECIMAL(18,4)) AS RelQty
