...
SELECT 
    ...
    CAST(ISNULL(il.fkLocationId, '')  AS NVARCHAR(255))      AS [LOCATION_NO],
    ...
    CAST(si.ItemDescription  AS NVARCHAR(1000))        AS [DESCRIPTION],
    ...
    CAST(si.PurchasePrice  AS DECIMAL(18,4))      AS [COST_PRICE],
    CAST(NULL AS DECIMAL(18,4))					 AS [PURCHASE_PRICE],
    CAST(NULL             AS DECIMAL(18,4))      AS [ORDER_MULTIPLE],
    CAST(NULL             AS DECIMAL(18,4))      AS [QTY_PALLET],
    CAST(CAST(CAST(si.DimDepth AS DECIMAL(18,4)) * CAST(si.DimWidth AS DECIMAL(18,4)) * CAST(si.DimHeight AS DECIMAL(18,4)) AS DECIMAL(18,4)) / 1000000 AS DECIMAL(18,4))     AS [VOLUME],
