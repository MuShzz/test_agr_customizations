CREATE TABLE [cus].[OpenSalesOrdersHeaders] (
    ...
    [NotesCount] NVARCHAR(255) NULL,
    [AffectsInOrderBook] NVARCHAR(255) NULL,
    [IsPickListPrinted] NVARCHAR(255) NULL,
    [IsRuleRun] NVARCHAR(255) NULL,
    [ConversionRate] NVARCHAR(255) NULL,
    [StockAllocation] NVARCHAR(255) NULL
);
