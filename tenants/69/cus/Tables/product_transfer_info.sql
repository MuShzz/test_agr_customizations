CREATE TABLE [cus].[product_transfer_info] (
    [product_item_no] NVARCHAR(255) NOT NULL,
    [location_no] NVARCHAR(255) NOT NULL,
    [transfer_from_location_no] NVARCHAR(255) NOT NULL,
    ...
    CONSTRAINT [PK_cus_product_transfer_info] PRIMARY KEY (location_no,product_item_no,transfer_from_location_no)
);
