...
AS
	   ...
	   GROUP BY p.PURCHID, p.ITEMID, id.INVENTLOCATIONID, CASE p.CONFIRMEDDLV WHEN '1900-01-01 00:00:00.000' THEN p.DELIVERYDATE ELSE p.CONFIRMEDDLV END, CAST(p.DATAAREAID AS NVARCHAR(4))
