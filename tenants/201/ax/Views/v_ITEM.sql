...
LEFT JOIN [ax].INVENTTABLEMODULE itm2 ON fi.ITEMID = itm2.ITEMID AND itm2.DATAAREAID = fi.DATAAREAID AND itm2.PARTITION = fi.PARTITION AND itm2.MODULETYPE = 1 -- Moduletype = 'Purchases'
