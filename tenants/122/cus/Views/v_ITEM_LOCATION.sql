    ...
    CREATE VIEW [cus].[v_ITEM_LOCATION] AS
       SELECT 
		...
		,CAST(IIF(it.PrchseItem = 'Y' AND it.InvntItem = 'Y' AND it.frozenFor = 'N', 0, 1) AS BIT) AS CLOSED --25.09.2024.BF - needs confirming from client
        ...
        ,CAST(itm1.Price AS DECIMAL(18,4)) AS [COST_PRICE] --cost price per location
		...
		FROM [cus].OITM it
		  ...
		  LEFT JOIN [cus].ITM1 itm1 ON itm1.ItemCode = it.ItemCode AND itm1.PriceList = 10
