...
AS
          ...
          ,CAST(CASE WHEN cc.BEA219ALIVEITEM = 'Yes' THEN 0 WHEN cc.BEA219ALIVEITEM = 'No' THEN 1 ELSE 0 END AS BIT) AS [CLOSED]
	   ...
	   LEFT JOIN fo.ProductInfo pi ON p.ITEMNUMBER = pi.PRODUCTNUMBER
	   LEFT JOIN fo.ProductExtraInfo pei ON pei.ITEMNUMBER = p.ITEMNUMBER
	   LEFT JOIN fo.StockLevel sl ON sl.ITEMNUMBER = p.ITEMNUMBER
	   LEFT JOIN fo_cus.CustomColumns_Products cc ON cc.ITEMNUMBER = p.ITEMNUMBER 
