...
-- ===============================================================================
CREATE VIEW [bc_rest_CUS].[v_BOM_COMPONENT_test]
AS
    ...
    --------------------
        ...
        (
            ...
            FROM bc_rest.production_bom_line WHERE 1=0
			AND ProductionBOMNo ='8651-0110'
