...
--
-- 07.03.2025.BF	Create cus version Added filter to check for setting data_mapping_items_exclude_closed_items
-- ===============================================================================
...
AS
	...
	AND IIF((SELECT core.get_setting_value('data_mapping_items_exclude_closed_items')) = 'true' AND i.Blocked = 1,1,0) = 0 --BF
