...
AS
    ...
    SELECT
        ...
        CAST(SUM(CAST(tol.TRANSFERQUANTITY AS DECIMAL(18,4)))AS DECIMAL(18,4)) AS [quantity]

    FROM fo.[TransferOrderLines] tol
	LEFT JOIN fo.TransferOrderHeader toh ON tol.TRANSFERORDERNUMBER = toh.TRANSFERORDERNUMBER
