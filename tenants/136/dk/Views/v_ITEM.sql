...
AS
    ...
    SELECT
        ...
        CAST(7 AS SMALLINT) 													AS [ORDER_FREQUENCY_DAYS],
		CAST(NULL AS SMALLINT ) 												AS [ORDER_COVERAGE_DAYS],
		CAST(NULL AS DECIMAL(18, 4))											AS [MIN_ORDER_QTY],
		--CAST(ISNULL(REPLACE(moq.[ISBN], ',', '.'),0) AS DECIMAL(18, 4))			AS [MIN_ORDER_QTY], 19.12.2024.DFS Customer Uses this field differently
        ...
        CAST(ipv.[Vendors.LastPurchasedPrice] AS DECIMAL(18,4)) 				AS [PURCHASE_PRICE],
