...
CREATE VIEW [dk_cus].[cc_PalletLayerQty]
AS
	...
	(
		...
		LEFT JOIN (select ItemCode, [Units.UnitQuantity] from [dk].import_product_units where [Units.UnitCode] = 'brelag') ipu on ipu.ItemCode = im.ItemCode
