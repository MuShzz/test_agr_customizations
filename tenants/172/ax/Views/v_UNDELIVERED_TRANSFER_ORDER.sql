...
AS
	   ...
	   WHERE	
		itt.TRANSFERSTATUS < 2  AND 1=0
	   GROUP BY itl.TRANSFERID, itl.ITEMID, itt.INVENTLOCATIONIDTO, itt.INVENTLOCATIONIDFROM, itl.RECEIVEDATE, CAST(itl.DATAAREAID AS NVARCHAR(4))
